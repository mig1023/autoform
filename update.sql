...
ALTER TABLE Branches
	...
	ADD COLUMN SubmissionTime TEXT,
	ADD COLUMN CollectionTime TEXT;
	
CREATE TABLE AutoSpbAlterAppData (
	ID INT(11) NOT NULL AUTO_INCREMENT,
	AppID INT(11) NULL DEFAULT NULL,
	HotelName VARCHAR(50) NULL DEFAULT NULL,
	HotelPostCode VARCHAR(10) NULL DEFAULT NULL,
	HotelCity VARCHAR(50) NULL DEFAULT NULL,
	HotelStreet VARCHAR(50) NULL DEFAULT NULL,
	HotelHouse VARCHAR(10) NULL DEFAULT NULL,
	CompanyIndex VARCHAR(10) NULL DEFAULT NULL,
	HomeAddr VARCHAR(50) NULL DEFAULT NULL,
	HomeCity VARCHAR(50) NULL DEFAULT NULL,
	HomeEmail VARCHAR(50) NULL DEFAULT NULL,
	JobName VARCHAR(50) NULL DEFAULT NULL,
	JobAddr VARCHAR(50) NULL DEFAULT NULL,
	JobCity VARCHAR(50) NULL DEFAULT NULL,
	JobPhone VARCHAR(50) NULL DEFAULT NULL,
	PRIMARY KEY (ID),
	INDEX AppID (AppID)
)
COLLATE='utf8_general_ci'
