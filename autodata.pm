...
# //////////////////////////////////////////////////
{
	...
	#30
		...
		'К сожалению, произошёл сбой проверки идентичности страницы. Возможно, ваш браузер нарушил целостность страницы '.
			'или произошла какая-то другая досадная неприятность. Пожалуйста, попробуйте обновить страницу и ввести '.
			'данные повторно. Если ошибка повториться, то попробуйте воспользоваться другим браузером', 
	];
}
