...
# //////////////////////////////////////////////////
{
	return {
		...
		3 => 'Восстановить доступ к записи',
		4 => '</a><br><br>',
		5 => 'После завершения записи, Вы сможете воспользоваться данной ссылкой для перехода на страницу информации о записи.<br><br>С уважением,<br>Итальянский визовый центр',
	};
};
