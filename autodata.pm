...
# //////////////////////////////////////////////////
{
	return {
		...
		3 => 'Моя запись в VMS',
		4 => '</a><br><br>',
		5 => 'Перейдя по этой записи Вы сможете:<br>1. Продолжить запись в Визовый центр, которую Вы ранее начали.<br>2. После завершения записи Вы сможете получать информацию о своей записи, отменить её или перенесети на другое время, распечатать уже заполненную шенгенскую анкету.<br>3. После подачи Вы сможете отслеживать статус документов, их отправку в Консульство и готовность к получению.<br><br>С уважением,<br>Итальянский визовый центр',
	};
};
