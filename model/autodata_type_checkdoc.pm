	...
	return {
		...
		'Предупреждение' => [
			...
			},
			{
				type => 'text',
				name => 'affari_warning',
				label => 'Если вы запрашиваете Affari <b>для моделей</b> - вам необходимо обратиться напряму в Визовый центр для подачи, онлайн-проверка документов <b>не производится</b>.',
			},
		],
